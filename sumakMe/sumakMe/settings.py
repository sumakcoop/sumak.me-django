...
# Django settings for sumakMe project.
#
...
def location(x): return os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', x)
...
WSGI_APPLICATION = 'sumakMe.wsgi.application'
